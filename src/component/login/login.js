...
const Login = (props) => {
  ...
  useEffect(() => {
    if (user.length === 0) {
      setMessage("OBS! You are not have account");
  ...
  return (
    <div className="grid grid-cols-3 gap-4 bg-slate-300  ">
      ...
      <div className=" col-start-2 col-end-3 m-5 max-w-md p-8 space-y-3 rounded-xl dark:bg-gray-900 dark:text-gray-100">
        <h1 className="text-2xl font-bold text-center">Login</h1>
        <form
          onSubmit={loginHandle}
          className="m-5 space-y-6 ng-untouched ng-pristine ng-valid items-center m-auto "
        >
          ...
          <p className="text-red-600/100 text-sm text-center">
            {message && message}
          </p>
          <div to="/main">
            <button
        ...
        <p className="text-xs text-center sm:px-6 dark:text-gray-400">
          ...
          <a href="/" className="underline dark:text-gray-100">
            Sign up
          </a>
        </p>
        {load ? (
